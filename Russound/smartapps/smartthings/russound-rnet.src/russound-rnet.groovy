/**
 *  SmartThings SmartApp: Russound RNET
 *
 *  Author: Matt_Teix
 *
...
definition(
  ...
  description: "Russound RNET SmartApp",
  category: "My Apps",
...
def lanResponseHandler(evt) {
  ...
  log.trace "Russound RNET event: ${evt.stringValue}"
  processEvent(body)
}
...
def discoverChildDevices() {
  sendCommand('/plugins/rnet/discover')
}
